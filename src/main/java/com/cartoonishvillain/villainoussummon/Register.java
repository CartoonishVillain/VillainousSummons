...
public class Register {
    ...
    public static final RegistryObject<EntityType<TurretArrow>> TURRETARROW = ENTITY_TYPES.register("turretarrow", () -> EntityType.Builder.<TurretArrow>of(TurretArrow::new, MobCategory.MISC).sized(0.5F, 1.975F).build(new ResourceLocation(VillainousSummon.MOD_ID, "turretarrow").toString()));
    public static final RegistryObject<EntityType<BallistaArrow>> BALLISTAARROW = ENTITY_TYPES.register("ballistaarrow", () -> EntityType.Builder.<BallistaArrow>of(BallistaArrow::new, MobCategory.MISC).sized(0.5F, 1.975F).build(new ResourceLocation(VillainousSummon.MOD_ID, "ballistaarrow").toString()));
