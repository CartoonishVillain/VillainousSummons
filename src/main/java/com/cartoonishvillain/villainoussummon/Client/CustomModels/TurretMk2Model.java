...
public class TurretMk2Model<T extends AbstractGolem> extends EntityModel<BaseTurretsMK2> {
	...
	public TurretMk2Model(ModelPart part) {
...
//		Stand.texOffs(0, 49).addBox(-2.0F, -24.0F, -2.0F, 4.0F, 21.0F, 4.0F, 0.0F, false);
	...
	public static LayerDefinition createLayer(){
        ...
        .texOffs(0, 0).addBox(-8.0F, -16.0F, -8.0F, 16.0F, 16.0F, 16.0F), PartPose.ZERO);
        partDefinition.addOrReplaceChild(STAND, CubeListBuilder.create()
        .texOffs(0, 32).addBox(-7.0F, -3.0F, -7.0F, 14.0F, 3.0F, 14.0F)
        .texOffs(0, 49).addBox(-2.0F, -24.0F, -2.0F, 4.0F, 21.0F, 4.0F), PartPose.ZERO);
