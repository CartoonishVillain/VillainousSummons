...
public abstract class BaseTurretsMK2 extends TurretTemplate implements IRangedAttackMob {
    ...
    protected void registerGoals(){
        this.goalSelector.addGoal(1, new RangedAttackGoal(this, 1.25D, 15, 15));
        this.goalSelector.addGoal(2, new LookRandomlyGoal(this));
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, MonsterEntity.class, 12, true, false, ATTACK_PREDICATE));
    }
